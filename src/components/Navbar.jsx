...
function Navbar() {
  return (
    <div className="w-full fixed z-[999] px-20 py-8  font-[Poppins] flex justify-between items-center bg-[#142926]">
      <div className="logo">
        <svg
          width="72"
          height="30"
      ...
      <div className="links ">
        {/* {['Home', 'Our Work', 'About Us', 'Insights', 'Contact'].map((item,index)=>(<a key={index} className={`text-lg  capitalize font-light ${index===4 && "ml-32"}` }>{item}</a>))} */}
        ...
        <ul className="hidden md:flex gap-5">
          ...
          <li>
            <Link to="/OurClients" className="cursor-pointer">
              Our Clients
            </Link>
          </li>
          <li>
            <Link to="/OurWork" className="cursor-pointer">
              Our Work
            </Link>
          </li>
          <li>
