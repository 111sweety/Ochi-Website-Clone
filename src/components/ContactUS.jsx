...
function ContactUS() {
    return (
        <div className="w-full flex gap-5 h-screen bg-zinc-900 p-20 px-20">
          <div className="w-1/2 h-full flex flex-col justify-between  ">
            <div className="Headings ">
              <h1 className="text-[7vw] font-bold leading-[9.5vw] -mb-10">EYE-</h1>
              <h1 className="text-[7vw] font-bold leading-[9.5vw] -mb-10">
                OPENING{" "}
              </h1>
            </div>
            <svg
          ...
          <div className="w-1/2">
            ...
            <div className="flex gap-10 justify-center ">
              ...
              <p className=" pb-5 font-bold">S :</p>
                <a className="block font-light text-sm" href="#">
                  Facebook
                </a>
                <a className="block font-light text-sm" href="#">
                  Instagram
              ...
              <div className="dets  mt-20 ">
              <p className=" pb-5 font-bold">L :</p>
                <a className="block font-light text-sm" href="#">
                  202-1965 W 4th Ave
                </a>
                <a className="block font-light text-sm" href="#">
              ...
              <div className="dets mt-20 ">
              <p className="pb-5 font-bold">M :</p>
                <a className="block font-light text-sm" href="#">
                  Home
                </a>
                <a className="block font-light text-sm" href="#">
              ...
              <div className="dets mt-20 ">
              <p className=" pb-5 font-bold">E :</p>
                <a className="block font-light text-sm" href="#">
                  hello@ochi.design
                </a>
              </div>
