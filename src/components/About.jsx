...
import menWomen from '../assets/images/men-women.jpg'

function About() {
  return (
    <div className='w-full p-20 bg-[#CDEA68] rounded-tl-3xl rounded-tr-3xl text-black'>
        <h1 className='text-[4vw]  leading-[4.5vw] tracking-tight font-[Poppins]'>
        ...
        <div className='w-full flex gap-5  pt-10 mt-20 border-t-[1px] border-[#a1b562]'>
            ...
            <div className='w-1/2 h-[70vh] '>
                <img className='rounded-3xl w-full' src={menWomen} alt="" />
            </div>
        </div>
    </div>
  )
